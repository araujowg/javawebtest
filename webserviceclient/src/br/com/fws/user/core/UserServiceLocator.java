...
public class UserServiceLocator extends org.apache.axis.client.Service implements br.com.fws.user.core.UserService {
    ...
    private java.lang.String User_address = "http://localhost:8080/web/services/User";
    ...
    public br.com.fws.user.core.User getUser(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.com.fws.user.core.UserSoapBindingStub _stub = new br.com.fws.user.core.UserSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.com.fws.user.core.User.class.isAssignableFrom(serviceEndpointInterface)) {
                br.com.fws.user.core.UserSoapBindingStub _stub = new br.com.fws.user.core.UserSoapBindingStub(new java.net.URL(User_address), this);
                _stub.setPortName(getUserWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://core.user.fws.com.br", "UserService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://core.user.fws.com.br", "User"));
        }
